  ...
  return (
    <div className="flex flex-row justify-between rounded-lg bg-white px-5 py-4 shadow-md">
      ...
      <div>
        ...
        <h1 className="mt-3 mb-3 text-2xl poppins-semibold text-primary md:text-3xl">
          {amount}
        </h1>
        <p className="text-sm poppins-medium text-gray-500">{percentage}</p>
      </div>

      {/* Right Side */}
      <div className="flex flex-col items-end justify-between">
        <button className="flex items-center gap-1 text-[10px] poppins-medium text-secondary">
          {buttonText}
